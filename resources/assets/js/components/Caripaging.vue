<template>
    <div>
        <h1>Posts</h1>
            ...
            <input type="text" v-model="query" v-on:keyup="okelah()">
            <br/>
       ...
       Pagination
        ...
        methods:{
            ...
            okelah(page=1){
                ...
                axios.get('http://localhost:8000/api/post/cari/'+this.query,{
                    params:{
                        page
                    }
                }).then(response=>{
                ...
                var jumlah=this.posts.length;
                if(jumlah==0){
                    this.kosong.datanya=!this.kosong.datanya;
                }
                else{
                    this.kosong.datanya=false;
                }
